 ...
 * @author teng
 */
public class RssFeedItemCreator extends ItemCreator
{
    private String url;
    private RssChannelReader reader;

    public RssFeedItemCreator(final Control c, final String name)
    {
        super(c, name);
    }

    public RssFeedItemCreator(final Control c, final String url, final String name)
    {
        this(c, name);
        this.url = url;
        reader = new RssChannelReader(url, name);
